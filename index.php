                        ...
                        <div class="cardapio-item">
                            <a href="prato.php?prato=<?php echo $row['codigo']; ?>">
                                ...
                                <div class="cardapio-item-image">
                                    <img src="img/cardapio/<?php echo $row['codigo']; ?>.jpg" alt="Foto do prato: <?php echo $prato_nome; ?>">   
                                </div>
                ...
                <div class="reservation-form small-12 columns no-padding">
                    ...
                    <?php 
                        ...
                        try {
                            ...
                            // Nome do usuário
                            $mail->Username = 'emailexemplo@gmail.com';        
                            // Senha do E-mail         
                            $mail->Password = 'senha';                           
                            ...
                            // Destinatário
                            $mail->addAddress('emailexemplo@gmail.com', 'Restô Bar');
